...
import me.sevj6.pvp.listener.listeners.exploits.*;
...
public class GeneralListenerManager extends Manager {
    ...
    public void init(PVPServer plugin) {
        ...
        plugin.getDispatcher().register(new BoatDisabler(), PacketPlayInFlying.class, PacketPlayInUseEntity.class, PacketPlayInFlying.PacketPlayInPosition.class, PacketPlayInFlying.PacketPlayInPositionLook.class, PacketPlayInVehicleMove.class, PacketPlayInSteerVehicle.class);
    }
